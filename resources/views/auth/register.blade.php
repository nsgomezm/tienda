            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" class="">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="Email confirm" class="form-control" name="email_confirmation" id="email_confirm" placeholder="Email confirm" required autocomplete="email">
                        </div>
